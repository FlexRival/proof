...
export const en = {
  ...
  paywall: {
    ...
    unlimitedDuels: 'Unlimited duels, every day',
    close: 'Close',
    restore: 'Restore',
    restoring: 'Restoring…',
    loadingPlans: 'Loading plans…',
    unavailable: 'Purchases are not available on this device right now.',
    tryAgain: 'Try again',
    subscribe: 'Subscribe',
    purchasing: 'Opening the store…',
    cancelAnytime: 'Cancel anytime',
    // Sufijos de periodo: se pegan al precio que ya formateó la store.
    perMonth: '/mo',
    perYear: '/yr',
    perMonths: '/%{count} mo',
    savings: 'Save %{percent}%',
    savingsWithPrice: 'Save %{percent}% (only %{price}/mo)',
    proTitle: "You're Pro",
    proMessage: 'Unlimited duels are unlocked on this account.',
    proConfirming: 'Confirming your purchase. Pro unlocks in a moment.',
    nothingToRestore: 'No active subscription on this account.',
    manageHint: 'Manage or cancel your subscription in the App Store or Google Play.',
